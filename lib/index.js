...
*
*	DESCRIPTION:
*		- Reduce transform stream which calculates the covariance of a numeric data stream.
*
*
*	NOTES:
*		[1] 
...
(function() {
	...
	* @param {array} means - 1d array of means
	...
	*/
	Stream.prototype.means = function( arr ) {
		...
		if ( !Array.isArray( arr ) ){
			throw new Error( 'means()::invalid input argument. Input means must be an array.' );
		}
		this._means = arr;
		return this;
	}; // end METHOD means()
